...
<%@ page errorPage="/error_categorie_not_found.jsp" %> 
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>

<html>
<head>
    
    <title> ${categorie.nom} et plus de goodies de mangas et jeux vidéos sur Otaku.ma</title>
...
<div id="container">
	<jsp:include page="header.jsp" flush="true"></jsp:include>
		...
		<c:forEach items="${branche_categories}" var="categ">
			<a href= ${ categ.link } >${categ.nom }</a> > 
	  	</c:forEach>
			<a href= ${ categorie.link } >${categorie.nom }</a>
	  </div>
		...
		<div class="col-md-offset-1 col-lg-offset-1 col-md-10 col-lg-10 col-sm-12 col-xs-12" style="margin-top: 5px;">
			...
			<form class="form-horizontal"  name="form" action="${categorie.link}" method="get" id="form">
	...
	<div class="col-md-offset-1 col-lg-offset-1 col-md-10 col-lg-10 col-sm-12 col-xs-12" style="margin-bottom: 15px;">	
		<div class="btn-group btn-group-toggle" role="group" data-toggle="buttons" style="float:right;margin-bottom: 200px;">
