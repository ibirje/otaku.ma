...
public abstract class ProduitDB implements TableWithCode, TableWithQte {
	...
	public ProduitDB(Produit s) {
		...
		image2 = s.getImage2();
		image3 = s.getImage3();
		prixUnite = s.getPrixUnite();
		prixPromo = s.getPrixPromo();
		
		Parse parse = new Parse();
		
		dateDebutPromo = parse.ParseDate(s.getDateDebutPromo());
		dateFinPromo   = parse.ParseDate(s.getDateFinPromo());
		extra1 = s.getExtra1();
		extra2 = s.getExtra2();
		extra3 = s.getExtra3();
		hasVariations = s.getHasVariations();
	}
	...
	public Integer getCommandes() {
		return commandes != null ? commandes : 0;
	}
